...
pub type bap_disasm = *mut ::std::os::raw::c_void;
pub type bap_mem = *mut ::std::os::raw::c_void;
pub type bap_bigstring = *mut ::std::os::raw::c_void;
pub type bap_bitvector = *mut ::std::os::raw::c_void;
pub type bap_insn = *mut ::std::os::raw::c_void;
...
pub type bap_disasm_insn = Struct_Unnamed1;
#[derive(Clone, Copy)]
#[repr(u32)]
...
pub type bap_segment = Struct_Unnamed2;
#[repr(C)]
#[derive(Copy)]
...
pub type bap_mem_c = Struct_Unnamed3;
#[repr(C)]
#[derive(Copy)]
...
pub type bap_symbol = Struct_Unnamed4;
#[repr(C)]
#[derive(Copy)]
...
impl Struct_Unnamed5 {
    pub unsafe fn imm(&mut self) -> *mut ::std::os::raw::c_int {
...
pub struct Struct_Unnamed6 {
    pub addr_size: ::std::os::raw::c_int,
    pub cell_size: ::std::os::raw::c_int,
}
...
impl Struct_bap_expr {
    pub unsafe fn load(&mut self) -> *mut Struct_Unnamed8 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn store(&mut self) -> *mut Struct_Unnamed9 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn binop(&mut self) -> *mut Struct_Unnamed10 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn unop(&mut self) -> *mut Struct_Unnamed11 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    ...
    pub unsafe fn cast(&mut self) -> *mut Struct_Unnamed12 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn _let(&mut self) -> *mut Struct_Unnamed13 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn unknown(&mut self) -> *mut Struct_Unnamed14 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn ite(&mut self) -> *mut Struct_Unnamed15 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn extract(&mut self) -> *mut Struct_Unnamed16 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn concat(&mut self) -> *mut Struct_Unnamed17 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
pub struct Struct_Unnamed16 {
    pub low_bit: ::std::os::raw::c_int,
    pub high_bit: ::std::os::raw::c_int,
    pub val: *mut Struct_bap_expr,
}
...
impl Struct_bap_stmt {
    pub unsafe fn _move(&mut self) -> *mut Struct_Unnamed18 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    ...
    pub unsafe fn special(&mut self) -> *mut *mut ::std::os::raw::c_char {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn s_while(&mut self) -> *mut Struct_Unnamed19 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn ite(&mut self) -> *mut Struct_Unnamed20 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn cpu_exn(&mut self) -> *mut ::std::os::raw::c_int {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
extern "C" {
    ...
    pub fn bap_render_stmt(arg1: *mut bap_stmt)
     -> *mut ::std::os::raw::c_char;
    pub fn bap_disasm_to_string(arg1: bap_disasm)
     -> *mut ::std::os::raw::c_char;
    pub fn bap_arch_to_string(arg1: bap_arch) -> *mut ::std::os::raw::c_char;
    pub fn bap_bitvector_to_string(arg1: bap_bitvector)
     -> *mut ::std::os::raw::c_char;
    pub fn bap_mem_to_string(arg1: bap_mem) -> *mut ::std::os::raw::c_char;
    pub fn bap_insn_to_asm(arg1: bap_insn) -> *mut ::std::os::raw::c_char;
    pub fn bap_render_segment(seg: *mut bap_segment)
     -> *mut ::std::os::raw::c_char;
    ...
    pub fn bap_bitvector_contents(bv: bap_bitvector)
     -> *mut ::std::os::raw::c_char;
    pub fn bap_project_mem(arg1: bap_mem) -> *mut bap_mem_c;
    pub fn bap_create_bitvector64(val: int64_t, width: int16_t)
     -> bap_bitvector;
    pub fn bap_create_bigstring(buf: *mut ::std::os::raw::c_char, len: size_t)
     -> bap_bigstring;
    ...
    pub fn bap_get_segments(buf: *mut ::std::os::raw::c_char, len: size_t)
     -> *mut *mut bap_segment;
    pub fn bap_get_symbols(buf: *mut ::std::os::raw::c_char, len: size_t)
     -> *mut *mut bap_symbol;
    pub fn bap_byteweight(arch: bap_arch, mem: bap_mem) -> *mut bap_addr;
    pub fn bap_get_arch(buf: *mut ::std::os::raw::c_char, len: size_t)
     -> bap_arch;
    pub fn bap_free(arg1: *mut ::std::os::raw::c_void);
    pub fn bap_init();
